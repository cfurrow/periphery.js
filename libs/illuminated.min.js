...
0,1,1);t.fillStyle=a;t.fillRect(0,0,1,1);a=t.getImageData(0,0,1,1).data;return{color:"#"+v(a[0])+v(a[1])+v(a[2]),alpha:Math.round(1E3*a[3]/255)/1E3}};a.extend=l;a.inherit=q})(window.illuminated={});
